...
// Cars (legacy route for timeline - update to use admin controller if needed, or keep as is)
Route::get('/api/cars', [AdminController::class, 'getCars']); // This was used by TimelineModal, let's update it to /admin/cars or just use /admin/vehicles
Route::get('/admin/cars', [AdminController::class, 'getCars']); // Alias for timeline
